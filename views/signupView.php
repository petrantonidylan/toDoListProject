    ...
    <div class="container d-flex justify-content-center align-items-center min-vh-100">
        <div class="card p-4 shadow-sm" style="max-width: 400px; width: 100%;">
            ...
            <form method="post">
                ...
                <div class="mb-3">
                    <label for="pass_1" class="form-label">Password</label>
                    <input type="password" class="form-control" id="pass_1" name="pass_1" required>
                </div>
                <div class="mb-3">
                    <label for="pass_2" class="form-label">Confirm password</label>
                    <input type="password" class="form-control" id="pass_2" name="pass_2" required>
                </div>
                <button type="submit" class="btn btn-primary w-100">Sign up</button>
                <div class="text-center mt-3">
                    <a href="index.php?controller=UserTask&action=signin">Sign in</a>
                </div>
            </form>
